...
namespace Log {
    ...
    public:
	    ...
	    ********************************************/
        static void
        setOutputFileOptions(const std::string &strLogPath, const std::string &strLogBaseName, const LogLevel logLevel,
                             const size_t logFileSize, const size_t logSaveDays = 7,
                             const LogFmtType logFmtType = STRING
        );
